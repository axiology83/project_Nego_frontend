...
function openPopup(path) {
  ...
  return (
    <div>
        ...
        {/* 이미지 */}
        <div className='imageBox-lg' style={{margin: '3em 2em 2em 0em'}}>
       <img style={{ height: '300px', width: '450px', }}
        src={previewImage? previewImage : '/img/nego1.png'} alt='preview' />
       </div>

        {/* 거래정보 */}
       <div style={{verticalAlign: 'center', display: 'inline-block', width: '300px', height: '210px', paddingInline: '3%', marginLeft: '1%', fontSize: 'larger'}}>
        
        판매자 : {board.sellInfoResponse.email} <button className='detailbutton' onClick={() => openPopup(`/chatwith/${board.sellInfoResponse.email}`)}><img src='/img/chatting.png' style={{widthd: '30px', height: '30px'}}/></button><br/>
